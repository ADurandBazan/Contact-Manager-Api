...
namespace ContactManager.Infrastructure.Common.Utilies
{
    ...
    public abstract class Repository<TEntity> : IRepository<TEntity> where TEntity : class, IEntity
    {
        ...
        public async Task<IEnumerable<TEntity>> GetAllByIdsAsync<TId>(IList<TId> elementIds, CancellationToken cancellationToken = default)
        {
            return await Entity.AsQueryable().Where(e => elementIds.Contains((TId)e.Id)).ToListAsync(cancellationToken);
        }
        #endregion
    }
}
